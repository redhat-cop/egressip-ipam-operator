...
func main() {
	...
	err = leader.Become(ctx, "egressip-ipam-operator-lock")
	if err != nil {
		log.Error(err, "")
		os.Exit(1)
	}
	...
	if err := ocpnetv1.AddToScheme(mgr.GetScheme()); err != nil {
		log.Error(err, "")
		os.Exit(1)
	}
	...
	if err := cloudcredentialv1.AddToScheme(mgr.GetScheme()); err != nil {
		log.Error(err, "")
		os.Exit(1)
	}
